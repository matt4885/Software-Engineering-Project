...
public class Driver{
    ...
    private void initObservables(){
        ...
        System.out.println("Test point 7, Customer Portfolio observing Client for changes");
        System.out.println("Number of Observers observing Client: " +client.countObservers());
        System.out.println("Client current commission rate: " +client.getCommissionRate());
    }
